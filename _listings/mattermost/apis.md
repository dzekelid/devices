...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/devices/master/_listings/mattermost/apis.md
...
- name: Mattermost API Reference - Attach mobile device
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/devices/master/_listings/mattermost/userssessionsdevice-put-openapi.md
- name: Mattermost API Reference - Attach mobile device
  x-api-slug: userssessionsdevice-put
  description: |-
    Attach a mobile device id to the currently logged in session. This will enable push notiofications for a user, if configured by the server.
